...
export function IntegratedChatInput({
  ...
  return (
    <div className={cn("flex flex-col border shadow-sm bg-white max-w-[60%] mx-auto", className)}>
      {/* Attachments area */}
      {attachments.length > 0 && (
        <div className="flex flex-wrap gap-2 p-3">
          {attachments.map((attachment) => (
            <div key={attachment.id} className="flex items-center bg-[#F7F5F5] rounded-full px-3 py-1 text-sm">
      ...
      <div className="px-3 pt-3 relative">
        <textarea
          ...
          rows={1}
          className="w-full bg-transparent border-0 focus:ring-0 focus:outline-none resize-none min-h-[40px] max-h-[200px] overflow-y-auto text-gray-700"
          style={{ height: "40px" }}
        />
        ...
        {showCommandMenu && commandOptions.length > 0 && (
          <div
            ref={commandMenuRef}
            className="absolute bg-white border border-gray-200 shadow-md z-50"
            style={{
          ...
          >
            {commandOptions.map((option, index) => (
              <button
                key={option.id}
                className={cn(
                  "flex items-center justify-between w-full px-4 py-3 text-sm text-left cursor-pointer hover:bg-gray-50",
      ...
      <div className="flex items-center justify-between px-3 pb-3">
        <div className="flex items-center space-x-2">
          <DropdownMenu>
            <DropdownMenuTrigger className="flex items-center rounded-full px-4 py-2 bg-[#F7F5F5]">
            ...
            <DropdownMenuContent
              ...
              sideOffset={4}
            >
              <DropdownMenuItem className="flex items-center justify-between py-3 px-4 cursor-pointer hover:bg-gray-50 border-b border-gray-100">
                General
              ...
              <DropdownMenuItem className="py-3 px-4 cursor-pointer hover:bg-gray-50 border-b border-gray-100">
                Personal
              </DropdownMenuItem>
              <DropdownMenuItem className="py-3 px-4 cursor-pointer hover:bg-gray-50 border-b border-gray-100">
                GMT Playbook
              </DropdownMenuItem>
              <DropdownMenuItem className="py-3 px-4 cursor-pointer hover:bg-gray-50">Products</DropdownMenuItem>
            </DropdownMenuContent>
          </DropdownMenu>
          <FilterButton />
          ...
          <div className="relative menu-container">
            <button
              ...
              className="flex items-center justify-center rounded-full h-9 w-9 bg-[#F7F5F5] hover:bg-[#E7E5E5] cursor-pointer"
            >
              <Plus size={16} />
            ...
            {isPlusMenuOpen && (
              <div className="absolute bottom-full left-0 mb-2 w-[250px] bg-white border border-gray-200 shadow-md z-50">
                <button
                  className="flex items-center justify-between w-full px-4 py-3 text-sm text-left cursor-pointer hover:bg-gray-50 border-b border-gray-100"
                ...
                <button
                  className="flex items-center justify-between w-full px-4 py-3 text-sm text-left cursor-pointer hover:bg-gray-50"
        ...
        <Button
          size="icon"
          className="bg-[#1CDBBC] hover:bg-[#1CDBBC]/90 text-white rounded-full h-10 w-10"
          onClick={handleSend}
        >
